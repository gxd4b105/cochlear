...
class NucleusProfileEarImplants extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getNucleusProfileEarImplants());
    }
...
//        console.log(this.props.dataProductsAndSolutions);
        let getData = this.props.dataNucleusProfileEarImplants;
        let json = {
            "breadcrumbs": [{ title: "Home", link:'/intl/home' },
                            { title: "Products & Solutions", link: '/intl/products-and-solutions' },
                            { title: "Nucleus profile ear implants", link: '/intl/nucleus-profile-ear-implants'}
            ]
        };
        return (
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(NucleusProfileEarImplants);
