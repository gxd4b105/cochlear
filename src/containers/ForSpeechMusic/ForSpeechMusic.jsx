...
class ForSpeechMusic extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getForSpeechMusic());
    }
    ...
    render() {
        ...
        console.log(this.props.dataForSpeechMusic);
        let getData = this.props.dataForSpeechMusic;
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(ForSpeechMusic);
