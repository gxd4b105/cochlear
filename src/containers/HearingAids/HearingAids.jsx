...
class HearingAids extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getHearingAids());
    }
    ...
    render() {
        let getData = this.props.dataHearingAids;
        let json = {
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(HearingAids);
