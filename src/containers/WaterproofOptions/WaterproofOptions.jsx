...
class WaterproofOptions extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getWaterproofOptions());
    }
    ...
    render() {
        ...
        console.log(this.props.dataWaterproofOptions);
        let getData = this.props.dataWaterproofOptions;
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(WaterproofOptions);
