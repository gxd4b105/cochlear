...
class SearchResults extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getSearchResults());
    }
    ...
    render() {
        ...
        console.log(this.props.dataSearchResults);
        let getData = this.props.dataSearchResults;

        let json = {
            "breadcrumbs": [{   title: "Home", link:'/intl/home' },
                {   title: "Search Results", link: '/intl/search'}
            ]
        };
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(SearchResults);
