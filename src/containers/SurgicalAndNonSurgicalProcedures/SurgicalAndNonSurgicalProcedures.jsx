...
class SurgicalAndNonSurgicalProcedures extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getSurgicalAndNonSurgicalProcedures());
    }
    ...
    render() {
        ...
        //console.log(this.props.dataSurgicalAndNonSurgicalProcedures);
        let getData = this.props.dataSurgicalAndNonSurgicalProcedures;

        let json = {
            "breadcrumbs": [{   title: "Home", link:'/intl/home' },
                {   title: "Products and solutions", link: '/intl/products-and-solutions' },
                {   title: "This should point to the previus level - be done", link: '/intl/carina-middle-ear-implants'},
                {   title: "Surgical and non surgical procedures", link: '/intl/surgical-and-non-surgical-procedures'}
            ]
        };
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(SurgicalAndNonSurgicalProcedures);
