...
class MiddleEarImplants extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getMiddleEarImplants());
    }
    ...
    render() {
        let getData = this.props.dataMiddleEarImplants;
        let json = {
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(MiddleEarImplants);
