...
import Cm08ChildListing from "../../components/Cm08ChildListing/Cm08ChildListing.jsx";
import Cm08ChildListingItem from "../../components/Cm08ChildListingItem/Cm08ChildListingItem.jsx";

if (typeof window === 'undefined') {
    global.window = {}
}

class LifestyleFactors extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getLifestyleFactors());
    }
    ...
    render() {
        ...
        console.log(this.props.dataLifestyleFactors);
        let getData = this.props.dataLifestyleFactors;
        let json = {
        ...
        return (
            <div className="l-layout l-one-column cf">
                ...
                <BreadCrumbs jsonData={json}/>
                  ...
                  <Cm08ChildListing image={'https://auth.cochlear.com'+getData['cm02-image-04-01'].src} additionalClass={['l-padding']}>
                    <Cm08ChildListingItem title="Waterproof Options" path={getData['cm02-title-04-01'].path}/>
                    <Cm08ChildListingItem title="For noisy environments" path={getData['cm02-title-04-02'].path}/>
                    <Cm08ChildListingItem title="For an active life" path={getData['cm02-title-04-03'].path}/>
                    <Cm08ChildListingItem title="For speech and music" path={getData['cm02-title-04-04'].path}/>
                  </Cm08ChildListing>
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(LifestyleFactors);
