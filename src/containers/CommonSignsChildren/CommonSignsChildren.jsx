...
class UntreatedHearingLossChildren extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getCommonSignsChildren());
    }
    ...
    render() {
        ...
        console.log(this.props.dataCommonSignsChildren);
        let getData = this.props.dataCommonSignsChildren;
        let json = {
            "breadcrumbs": [{ title: "Home", link:'/intl/home' },
                            { title: "Hearing Loss", link: '/intl/hearing-loss' },
                            {   title: "Signs of hearing loss", link: '/intl/signs-of-hearing-loss'},
                            {   title: "Common signs for hearing loss for children", link: '/intl/common-signs-in-children'}
