...
class ProductsAndSolutions extends Component {
    static fetchData({ store, params }) {
        return store.dispatch(actions.getProductsAndSolutions());
    }
...
//        console.log(this.props.dataProductsAndSolutions);
        let getData = this.props.dataProductsAndSolutions;
        let json = {
                            ...
                            <div className="sl-list has-3-items">
                                ...
                                <div className="sl-item">
                                    <Cm02ContentTile    //title={getData['cm02-title-02-02'].title}
                                                        ...
                                                        title="Carina middle-ear"
                                                        description="You won't believe it! Carina Middle Ear Implants for the win!"
                                                        path="/intl/carina-middle-ear-implants"
                                ...
                                <div className="sl-item">
                                    <Cm02ContentTile    //title={getData['cm02-title-02-01'].title}
                                                        //description={getData['cm02-description-02-01']}
                                                        // path={getData['cm02-title-02-01'].path}
                                                        title="Baha Bone Conduction System"
                                                        description="Wow.. impressive Baha Bone Conduction system!"
                                                        path="/intl/baha-bone-conduction-system"
                                                        image={'https://auth.cochlear.com'+getData['cm02-image-02-01'].src}
                                                        imagePath={getData['cm02-title-02-01'].path}
                                                        embed = {getData['cm02-video-embed-02-01']}
                                                        additionalClass="is-small"/>
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(ProductsAndSolutions);
